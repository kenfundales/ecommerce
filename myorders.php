...
<body>
    ...
    <div class="leftside">
            <div class="profilecontainer">
                <img src="userimg/<?php echo $retrato;?>">
        ...
        <div class="rightside">      
            <div class="profilecontent">
                <div class="heading">
                    <?php 
                        $filter = isset($_GET['filter']) ? $_GET['filter'] : 'My Orders';
                    ?>
                ...
                <?php 
                    ...
                    $sql = "SELECT product_tbl.*, order_tbl.*, customer_tbl.* FROM order_tbl 
                            INNER JOIN customer_tbl ON order_tbl.customerId = customer_tbl.customerId 
                            INNER JOIN product_tbl ON order_tbl.productId = product_tbl.productId 
                            WHERE order_tbl.customerId = ?";
                    if ($filter) {
                        $sql .= " AND actionn LIKE '%$filter%'";
                    }
                ...
                <?php }
                        ...
                        echo "<p style='text-align: center;font-size:30px;'>No orders</p>";
                    }
                ?>
            </div>
        </div>
