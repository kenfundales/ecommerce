...
<body>
    ...
    <div class="audiencesection">
        ...
        <div class="model">
            <a href="productlanding.php?category=Men's Shoes" class="product-link">
                <img src='pictures/men.png'>
                <button>Shop Men's</button>
            </a>
            <a href="productlanding.php?category=Women's Shoes" class="product-link">
                <img src="pictures/women.png">
                <button>Shop Women's</button>
            </a>
            <a href="productlanding.php?category=Kids' Shoes" class="product-link">
